...
import headerDemoDay from "../images/header-demoday_2022.png";
...
const CategoriesPage = (props) => {
  ...
  const categoriesList = categories.map((category) => {
    return (
      ...
      >
        <h2 className="category-page-title">{category.categoryTitle}</h2>
      </Link>
    );
  });
    ...
    <>
      <div className="categories-page">
        ...
        <div className="categories-list">
          ...
          >
            <h2 className="category-page-title">Demo Day</h2>
          </Link>
        </div>
      </div>
